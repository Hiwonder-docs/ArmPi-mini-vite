...
const docsBase = normalizeBase(process.env.DOCS_BASE || '/projects/ArmPi_mini/en/latest/')
...
export default defineConfig({
  base: docsBase,
  title: 'ArmPi mini Documentation',
  description: 'ArmPi mini robot documentation',
